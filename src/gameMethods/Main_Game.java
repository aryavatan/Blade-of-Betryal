...
implements Runnable, KeyListener{
	...
	public void init(){
		...
		mainTheme = getAudioClip(getCodeBase(), "bin/MTHEME.au");
		overworld = getAudioClip(getCodeBase(), "bin/Overworld.au");
		battle = getAudioClip(getCodeBase(), "bin/battle.au");
                
		menu = getImage(getCodeBase(), "bin/menu.jpg");
		controls = getImage(getCodeBase(), "bin/Controls.jpg");
		credits = getImage(getCodeBase(), "bin/Credits.jpg");
		levels = getImage(getCodeBase(), "bin/Continue.jpg");
		gameOver = getImage(getCodeBase(), "bin/GAMEOVER.jpg");
		
		map = getImage(getCodeBase(), "bin/map.jpg");
		water = getImage(getCodeBase(), "bin/Water.jpg");
		
		battleGuard = getImage(getCodeBase(), "bin/BattleGuard.jpg");
		battlePrince = getImage(getCodeBase(), "bin/BattlePrince.jpg");
		battleKing = getImage(getCodeBase(), "bin/BattleKing.jpg");
		battleMonster = getImage(getCodeBase(), "bin/BattleMonster.jpg");
		battleOrc = getImage(getCodeBase(), "bin/BattleOrc.jpg");
		
		for(int i = 0; i < 3; i++){
			playerUP[i] = getImage(getCodeBase(), "bin/Player-UP" + (i+1) + ".png");
			playerDOWN[i] = getImage(getCodeBase(), "bin/Player-DOWN" + (i+1) + ".png");
			playerLEFT[i] = getImage(getCodeBase(), "bin/Player-LEFT" + (i+1) + ".png");
			playerRIGHT[i] = getImage(getCodeBase(), "bin/Player-RIGHT" + (i+1) + ".png");
		}
		//^^^FOR loop used to quickly assign images to these arrays
		
		guard = getImage(getCodeBase(), "bin/Guard.png");
		man = getImage(getCodeBase(), "bin/Man.png");
		blacksmith = getImage(getCodeBase(), "bin/Blacksmith.png");
		orc = getImage(getCodeBase(), "bin/Orc.png");
		healer = getImage(getCodeBase(), "bin/Healer.png");
		king = getImage(getCodeBase(), "bin/King.png");
		prince = getImage(getCodeBase(), "bin/Prince.png");
		
		story[0] = getImage(getCodeBase(), "bin/Pregame.jpg");
		for(int i = 1; i < 19; i++){
			story[i] = getImage(getCodeBase(), "bin/Text" + i + ".jpg");
		}
		
		arrow[0] = getImage(getCodeBase(), "bin/up.png");
		arrow[1] = getImage(getCodeBase(), "bin/up right.png");
		arrow[2] = getImage(getCodeBase(), "bin/right.png");
		arrow[3] = getImage(getCodeBase(), "bin/down right.png");
		arrow[4] = getImage(getCodeBase(), "bin/down.png");
		arrow[5] = getImage(getCodeBase(), "bin/down left.png");
		arrow[6] = getImage(getCodeBase(), "bin/left.png");
		arrow[7] = getImage(getCodeBase(), "bin/up left.png");
